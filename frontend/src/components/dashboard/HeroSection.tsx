 ...
 */
function calcPostureScore(overview: DashboardOverview): number {
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-2 shrink-0">
            ...
            <div className="relative w-24 h-24">
              ...
              <svg className={`w-full h-full -rotate-90${isHighRisk ? ' animate-breathe-glow-ring' : ''}`} viewBox="0 0 96 96">
                {/* 背景环 */}
                <circle
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className={`text-xl font-bold ${scoreColor(score)}${isHighRisk ? ' animate-breathe-glow' : ''}`}>
